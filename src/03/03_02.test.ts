...
import {addMoneyToBudget, createMessage, repairHouse, toFireStaff, toHireStaff} from "./03Lesson";
...
test("Greeting message should be correct for city",()=>{
    expect(createMessage(city)).toBe("Hello New York citizen. I want you be happy. All 100000 men")
})